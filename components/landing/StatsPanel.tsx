  ...
  return (
    <div className="w-full flex flex-col items-center gap-6 mt-16 px-4">
      ...
      <div className="flex flex-col items-center gap-1 mt-4">
        <span className="text-[9px] font-semibold text-neutral-400 dark:text-neutral-500 uppercase tracking-wider text-center">
          *Stats are illustrative placeholders for protocol historical performance.
        </span>
        <span className="text-[10px] font-extrabold tracking-[0.2em] text-neutral-400 dark:text-neutral-500 uppercase font-sans mt-2">
          WHY WINDMILL?
        </span>
      </div>
    </div>
